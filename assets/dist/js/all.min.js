...
$(document).ready((function(){$(".form-group").find(".floating-control").each((function(t,e){var a=$(e);""==a.val()&&!0!==a.is(":selected")||a.parents(".floating-group").addClass("focused")})),$(".floating-control").on("focus",(function(t){$(this).parents(".floating-group").addClass("focused")})).on("blur",(function(){$(this).val().length>0?$(this).parents(".floating-group").addClass("focused"):$(this).parents(".floating-group").removeClass("focused")})),$(".floating-control").on("change",(function(t){$(this).is("select")&&($(this).val()===$("option:first",$(this)).val()?$(this).parents(".floating-group").removeClass("focused"):$(this).parents(".floating-group").addClass("focused"))})),$(".customSelect").each((function(){var t=$(this).parents(".select2Part");$(this).select2({dropdownParent:t,minimumResultsForSearch:-1}).on("select2:open",(function(t){$(this).parents(".floating-group").addClass("focused")})).on("select2:close",(function(t){""===$(this).find(":selected").val()&&$(this).parents(".floating-group").removeClass("focused")}))}))})),$("#file-upload").change((function(){var t=this.value.match(/([^\/\\]+)$/)[1];$("#filename").text(t)})),$("#file-upload-2").change((function(){var t=this.value.match(/([^\/\\]+)$/)[1];$("#filename-2").text(t)})),$("#file-upload-3").change((function(){var t=this.value.match(/([^\/\\]+)$/)[1];$("#filename-3").text(t)})),$("#file-upload-4").change((function(){var t=this.value.match(/([^\/\\]+)$/)[1];$("#filename-4").text(t)})),$("#file-upload-5").change((function(){var t=this.value.match(/([^\/\\]+)$/)[1];$("#filename-5").text(t)})),$("#file-upload-6").change((function(){var t=this.value.match(/([^\/\\]+)$/)[1];$("#filename-6").text(t)})),$("#file-upload-7").change((function(){var t=this.value.match(/([^\/\\]+)$/)[1];$("#filename-7").text(t)})),$("#file-upload-8").change((function(){var t=this.value.match(/([^\/\\]+)$/)[1];$("#filename-8").text(t)})),$(".form-check .add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$(".form-check.style-2 .add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$(".add-after2").after('<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="10" height="10" rx="5" transform="matrix(1 0 0 -1 5 15)" fill="#3384D8"/></svg>');