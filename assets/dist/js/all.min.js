...
$("#file-upload").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename").text(e)})),$("#file-upload-2").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename-2").text(e)})),$("#file-upload-3").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename-3").text(e)})),$("#file-upload-4").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename-4").text(e)})),$("#file-upload-5").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename-5").text(e)})),$("#file-upload-6").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename-6").text(e)})),$("#file-upload-7").change((function(){var e=this.value.match(/([^\/\\]+)$/)[1];$("#filename-7").text(e)})),$(".form-check .add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$(".form-check.style-2 .add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>');const getDatePickerTitle=e=>{const t=e.nextElementSibling;let a="";return a=t&&"LABEL"===t.tagName?t.textContent:e.getAttribute("aria-label")||"",a},elems=document.querySelectorAll(".datepicker_input");for(const e of elems){new Datepicker(e,{format:"dd/mm/yyyy",title:getDatePickerTitle(e)})}